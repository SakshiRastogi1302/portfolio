...
const ProjectComponent = ({projectInfo}) => {
    const {imageURL, projectName, projectStatus, projectDescription, technologyStack, liveDemoLink, githubCodeLink} = projectInfo;
    ...
    return(
        <div className='w-[90%] md:w-3/4 lg:w-[90%] bg-purple-500 border-2 border-white shadow-lg shadow-black rounded-lg flex flex-col lg:flex-row items-center lg:items-start mx-auto hover:scale-105 hover:shadow-xl transition-transform cursor-pointer'>
