    ...
    <div className='bg-purple-900 w-full min-h-screen flex flex-col-reverse lg:flex-row items-center text-white gap-8 xl:px-20 py-56 lg:py-0'>
      <div className='flex flex-col justify-center w-full lg:w-1/2 px-10 pt-4 sm:pt-5 md:pt-6 lg:pt-12'>
        <div className='font-bold flex-wrap text-center lg:text-left leading-snug lg:mt-20'>
          ...
          <p className='text-justify font-light mt-3 sm:mt-4 md:mt-5 text-base sm:text-lg md:text-xl'>Thank you for visiting my portfolio. If you’re interested in collaborating or discussing potential opportunities, please don’t hesitate to get in touch. I look forward to connecting with you.</p>
          <div className='mt-5'>
            <p className='text-lime-400 text-xs sm:text-sm md:text-lg flex-wrap xs:text-center lg:text-left'><i className="fa-solid fa-location-dot mr-2"></i>Location: <span className='font-normal text-yellow-400 flex-wrap text-center'>Delhi, India</span></p>
            <div className='flex sm:justify-center lg:justify-start'>
              <p className='text-lime-400 text-xs sm:text-sm md:text-lg flex-wrap xs:text-center lg:text-left'><i className="fa-solid fa-envelope mr-2"></i>Email: <span className='font-normal text-yellow-400 flex-wrap text-center'>sakshi.dev2020@gmail.com</span></p>
              <button onClick={handleCopy} title={copied?'Email copied':'Copy Email Address'} className='cursor-pointer'>{copied? <Check className='text-green-400 rounded-full ml-2' title='Email Copied'></Check> : <Copy className='ml-2 w-4 md:w-6'></Copy>}</button>
            </div>
          </div>
      ...
      <div className='flex justify-center lg:justify-end w-full lg:w-1/2 px-6 lg:px-10 lg:pt-10 py-10'>
