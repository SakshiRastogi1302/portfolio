    ...
    <div className='bg-purple-900 w-full min-h-screen flex flex-col justify-center'>
      <div className='flex flex-col xl:flex-row lg:px-10'>
          ...
          <div className='flex flex-col justify-center w-full xl:w-3/4 px-6 lg:px-24 xl:pt-24 gap-4'>
              <h1 className='inline-block mx-auto text-3xl sm:text-4xl font-el-messiri font-bold tracking-wider text-white flex-wrap text-center leading-snug animate-moveDown drop-shadow-lg drop-shadow-black border-b-4 border-yellow-400'>About Me</h1>
