...
const AboutComponent = () => {
  return (
      <div className='bg-purple-900 w-full min-h-screen flex flex-col xl:flex-row'>
          ...
          <div className='flex flex-col justify-center w-full xl:w-3/4 px-6 lg:px-24 xl:pt-10 gap-4'>
              <h1 className='text-3xl sm:text-4xl font-el-messiri font-bold tracking-wider text-white flex-wrap text-center leading-snug animate-moveDown text-shadow-lg text-shadow-black border-b-6 border-yellow-400 pb-1'>About Me</h1>
