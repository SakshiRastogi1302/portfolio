    ...
    <div className='bg-purple-900 w-full min-h-screen flex flex-col justify-center'>
      <div className='flex flex-col xl:flex-row lg:px-10'>
          <div className='flex justify-center xl:justify-start xl:items-center w-full xl:w-1/2 px-4 sm:px-8 lg:px-10'> 
            <img src={profilePhoto} alt='My Profile Pic' className='w-40 h-40 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-72 lg:h-72 xl:w-96 xl:h-96 rounded-full mt-32 mb-8 sm:mt-36 md:mt-40 lg:mt-36 lg:ml-10 border-16 border-double border-yellow-400 pb-1'></img>
          </div>
